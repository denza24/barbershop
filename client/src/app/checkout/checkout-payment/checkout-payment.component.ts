...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe('pk_test_51MZBO5Ek5EtK65QTTTJlF9GtTiAD7qnqrC6Ok4p4gi9hJrrjAbJAoShFqnFn4ljOaxSimEHnFZI8yQmKcjldvZD200wmmUGYEg')
    .then(stripe  => { 
        this.stripe = stripe; 
  ...
  private confirmPaymentWithStripe(basket: Basket) {
